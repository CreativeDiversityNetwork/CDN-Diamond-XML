...
| File | Description |
|------|-------------|
| `diamond2-pdx-programmes-v1.1.xsd` | XSD schema for PRE-TX (Programmes) documents |
| `diamond2-pdx-publications-v1.1.xsd` | XSD schema for POST-TX (Publications) documents |
...
```bash
xmllint --schema diamond2-pdx-programmes-v1.1.xsd --noout Diamond2_PreTX_Example.xml
xmllint --schema diamond2-pdx-publications-v1.1.xsd --noout Diamond2_PostTX_Example.xml
```
